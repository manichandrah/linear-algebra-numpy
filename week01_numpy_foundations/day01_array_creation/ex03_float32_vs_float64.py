...
import numpy as np
print(f"7x7 Matrix filled with 7.0 having data type as float32 is\n{np.full((4, 4), 7.0, dtype = np.float32)},\nspace for float32 is {np.full((4, 4), 7.0, dtype = np.float32).nbytes}")
print(f"Space for float64 is {np.full((4, 4), 7.0, dtype = np.float64).nbytes}")
